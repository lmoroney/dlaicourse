...
extension UIImage {
  ...
  func grayScalePixelBuffer() -> CVPixelBuffer? {
    ...
    let attrs = [kCVPixelBufferCGImageCompatibilityKey: kCFBooleanTrue, kCVPixelBufferCGBitmapContextCompatibilityKey: kCFBooleanTrue, kCVPixelBufferExtendedPixelsTopKey : 0 as CFNumber, kCVPixelBufferExtendedPixelsBottomKey : 0 as CFNumber, kCVPixelBufferExtendedPixelsLeftKey : 0 as CFNumber, kCVPixelBufferExtendedPixelsRightKey : 0 as CFNumber] as CFDictionary
